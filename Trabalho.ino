...
int pinoG = 11;// Pino onde o led verde esta conectado no arduino
int pinoB = 12; //Pino onde o o led azul esta conectado no arduino
#define LMTYPE LM35
...
temperatura = (analogRead(sensorPin) * 0.0048828125 * 100); //recebe a temperatura medida e converte para graus celsius
  ...
  digitalWrite(transPin,HIGH); // transistor ligado
      ...
      Firmata.sendAnalog(sensorPin,temperatura);
}
}
